"""
`word2vec(train, output; size=100, window=5, sample=1e-3, hs=0,  negative=5, threads=1, iter=5, min_count=5, alpha=0.025, debug=2, binary=1, cbow=1, save_vocal=None, read_vocab=None, verbose=false,)`
...
function word2vec(train::AbstractString, output::AbstractString; 
                  ...
                  save_vocal=Union{}, read_vocab=Union{}, 
                  verbose::Bool=false)
...
"""
`word2cluster(train, output, classes; size=100, window=5, sample=1e-3, hs=0,  negative=5, threads=1, iter=5, min_count=5, alpha=0.025, debug=2, binary=1, cbow=1, save_vocal=None, read_vocab=None, verbose=false,)`
...
function word2clusters(train::AbstractString, output::AbstractString, 
                       ...
                       sample::AbstractFloat=1e-3, hs::Int=0, 
                       negative::Int=5, threads::Int=1, iter::Int=5,
                       min_count::Int=5, alpha::AbstractFloat=0.025,
                       debug::Int=2, binary::Int=0, cbow::Int=1,
                       save_vocab=Union{}, read_vocab=Union{}, 
                       verbose=false)
    command = joinpath(dirname(@__FILE__), "..", "deps", "src", "word2vec-c", "./word2vec")
    parameters = AbstractString[]
    args = ["-train", "-output", "-size", "-window", "-simple", "-hs",
